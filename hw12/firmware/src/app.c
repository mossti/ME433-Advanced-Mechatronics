...
//            if (movement_length > 50) {
                ...
                if(inc>=250){
                    ...
                    short *imu_read=get_multi_IMU(0x20,14,temp);
                    if(imu_read[4]<2000 & imu_read[4]>-2000){xcommand=0;}else{
                        xcommand=-(imu_read[4]/2000);
                    }
                    if(imu_read[5]<2000 & imu_read[5]>-2000){ycommand=0;}else{
                        ycommand=-(imu_read[5]/2000);
                    }
                    appData.xCoordinate = (int8_t) (xcommand);
                    appData.yCoordinate = (int8_t) (ycommand);
                    sprintf(msg, "   %d   ,   %d  ", xcommand,ycommand);
