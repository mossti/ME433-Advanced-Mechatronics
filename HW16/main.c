...
int main() {
    ...
    while(1) {
        ...
        */
        ...
        for(y=0;y<32;y++){
            LCD_drawPixel(com,y+30,ILI9341_BLACK);
        }
        int speed = 0;
        int e = 0;
        ...
        if (com < c/2/2){
            e = c/2/2 - com;
            speed = 2399 - 50*(2399/c/2/2)*e; // when the com is all the way over, the motor is all off
            if(speed > 2399){
                speed = 2399;
            }
            if(speed < 0){
            ...
            DIR1 = 0; // reverse wheel 2 direction
            OC1RS = 650;//2399;
            //OC4RS = speed;
            OC4RS = 450;
            sprintf(message,"w1 = %d   ", OC1RS);
            drawString(140,100,message);
            sprintf(message,"w2 = %d   ", OC4RS);
            drawString(140,108,message);
        }
        if (com = c/2/2){ // conditional for linear motion
            OC1RS = 650;
            OC4RS = 650;            
            sprintf(message,"w1 = %d   ", OC1RS);
            drawString(140,100,message);
            ...
            DIR2 = 0; // reverse wheel 1 direction
            //OC1RS = speed;
            OC1RS = 450;
            OC4RS = 650;//2399;
            sprintf(message,"w1 = %d   ", OC1RS);
